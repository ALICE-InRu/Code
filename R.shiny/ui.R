...
sidebar <- dashboardSidebar(
  sidebarMenu(
    ...
    menuItem("Optimality", icon = icon("gittip"),
    ...
    menuItem("Footprints", tabName = "tabFootprint", icon = icon("hand-o-right"),
             menuSubItem("Difficulty", tabName = "sdrDifficulty", icon = icon("trophy")),
             menuSubItem("Stepwise", tabName = "footprint", icon = icon("calendar"))
             ),
