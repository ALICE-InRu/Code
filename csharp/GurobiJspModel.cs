...
namespace Scheduling
{
    public class GurobiJspModel
    {
            ...
            bool optimise = false)
        {
            ...
            DecisionVariables();
            ProcessingOrder(prob.ProcessingTimes, prob.PermutationMatrix);
            DisjunctiveCondition(prob.ProcessingTimes);
            Objective(prob.ProcessingTimes, prob.PermutationMatrix);
